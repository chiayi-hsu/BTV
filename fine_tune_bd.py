...
def finetune(args):
    ...
    ckpdir = os.path.join(args.save, train_dataset, args.attack_method, f"poison_rate_{args.poison_rate}")
    p=1
...
if __name__ == '__main__':
    ...
    models = ['convnext_base','ViT-B-32', 'RN50x4', 'ViT-B-16']#'convnext_base','ViT-L-14',

    datasets=['CIFAR100', 'GTSRB']
    #datasets =['MNIST','SVHN','CIFAR10','GTSRB','CIFAR100']
    attack_method = ['badnet']#['badnet','blend', 'wanet']#
    ...
    for tp in trig_types:
        for attack in attack_method:
            for pr in poison_rate:
                for model in models:
                    # if model == 'convnext_base' and pr == 0.03:
                    #     pass
                    # else:
                        for dataset in datasets:
                            ...
                            args.save = f'checkpoints_poison/{model}'
                            finetune(args)
